...
// Wi-Fi settings
const char* ssid = "Tomatina";
const char* password = "tomatina20";


// Corlysis Setting - click to the database to get those info
const char* dbName = "bme";
const char* dbPassword = "dbPassword";
...
void sendDataToCorlysis(float temperature, float pressure, float humidity) {
    ...
    char payloadStr[150];
    sprintf(payloadStr, "bme280_wifi_data temperature=%d.%02d,pressure=%d.%02d,humidity=%d.%02d", (int)temperature, (int)abs(temperature*100)%100, 
